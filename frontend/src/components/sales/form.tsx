  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      <div className="p-fluid">
        ...
        <div className="grid">
          ...
          <div className="column is-fullwidth">
            <DataTable value={formik.values.itens} dataKey="product.id">
              ...
              />
              <Column
                body={(saleItem: SaleItem) => {
                  const handleRemoveProduct = () => {
                    const newProductList = formik.values.itens?.filter(
                      (si) => si.product.id !== saleItem.product.id
                    );
                    formik.setFieldValue("itens", newProductList);
                  };
                  return (
                    <Button
                      type="button"
        ...
        {!saleCompleted && <Button type="submit" label="Done" />}
        {saleCompleted && (
          <Button
            type="button"
            label="New"
